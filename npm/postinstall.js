...
const OWNER = "dvcrn";
const REPO = "grok-oauth-proxy";
const BIN = "grok-oauth-proxy";
const VERSION_ENV = "GROK_PROXY_VERSION";
const BASE_URL_ENV = "GROK_PROXY_BASE_URL";
const ARCH_ENV = "GROK_PROXY_ARCH";
const PLATFORM_ENV = "GROK_PROXY_PLATFORM";
...
async function installBinary() {
  ...
  if (!["darwin", "linux", "windows"].includes(platform)) {
    throw new Error(
      "grok-oauth-proxy: npm install supports macOS (darwin), Linux, and Windows only",
    );
  }
